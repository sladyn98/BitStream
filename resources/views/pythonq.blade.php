...
<body style="background-color:rgb(5,32,45);">
    ...
    <div class="jumbotron" style="padding:10px;background-color:rgb(5,32,45);">
        <h1 style="color:#f9efc1;"><strong>Welcome to Python!</strong><br></h1>
        <p style="font-size:20px;color:#f9efc1;"><br>Welcome to the world of Python! In this challenge, we practice printing to stdout.<br>Complete the&nbsp;<em>main</em>&nbsp;method by copying the two lines of code below and pasting them inside the body of your&nbsp;<em>main</em>&nbsp;method.<br><br>print("Hello,
            World.");<br>print("Hello, Python.")<br><br><br></p>
        <p style="text-align: center">
            <a class="btn btn-primary" role="button" href="{{route('code_editor',['id'=>"P01",'lang'=>"PYTHON"])}}" style="background-color:#f96302;color:#f9efc1;">Solve</a></p>
    </div>
