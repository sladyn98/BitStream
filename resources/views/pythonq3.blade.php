...
<body style="background-color:rgb(5,32,45);">
    ...
    <div class="jumbotron" style="padding:10px;background-color:rgb(5,32,45);">
        ...
        <p style="text-align: center"><a class="btn btn-primary" role="button" href="{{route('code_editor',['id'=>"P03",'lang'=>"PYTHON"])}}" style="background-color:#f96302;color:#f9efc1;">Solve</a></p>
    </div>
